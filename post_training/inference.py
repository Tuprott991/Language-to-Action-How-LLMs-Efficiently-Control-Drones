...
prompt = "You are a drone flight planner. Given the start, goal, grid shape, and no-fly zones, produce a low-level action plan to navigate from start to goal while avoiding no-fly zones.\n" \
            "Grid shape: [10, 10, 3]\n" \
            "Start: [0, 0, 0]\n" \
            "Goal: [9, 9, 2]\n" \
